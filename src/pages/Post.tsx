            ...
            <div data-scroll-container className="flex-1 overflow-y-auto px-4 pb-6 mt-[23px]">
              ...
              <div className="mx-auto max-w-xs">
                <textarea
                  ...
                  rows={2}
                  className="text-sm-override mb-4 w-full resize-none rounded-xl border border-border bg-muted/30 px-3 py-2 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                />
              </div>
